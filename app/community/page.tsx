...
const UserCard: React.FC<UserCardProps> = ({ name, role, description, location }) => {
  return (
    <div className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5 p-4">
      <div className="bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="bg-cover bg-center h-56 p-4" style={{ backgroundImage: "url('https://placehold.co/600x600')" }}>
...
const Community: NextPage = () => {
    ...
    const users = [
      { name: 'John Doe', role: 'Chief Executive', description: 'Lorem ipsum dolor...', location: 'Google | New York' },
      // ... other users
    ];
