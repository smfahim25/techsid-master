...
interface Contest {
  ...
  const ContestCard: React.FC<Contest> = ({ name, image, description }) => {
    return (
      <div className="p-4 shadow-lg rounded-lg bg-white">
        <img src={image} alt={name} className="rounded-t-lg w-full" />
        <div className="p-4">
  ...
  const RankingCard: React.FC<Ranking> = ({ name, points, image }) => {
    return (
      <div className="flex items-center p-4 shadow-lg rounded-lg bg-white my-2">
