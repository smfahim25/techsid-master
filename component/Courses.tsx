...
const courses = [
  {
    id: 1,
    title: "Solidity",
    description: "Dive deep into smart contract development for Ethereum blockchain.",
    rating: 4.8,
    reviewCount: 5000,
  ...
  },
  {
    id: 5,
    title: "NodeJS",
    description: "Understand backend development with NodeJS, the JavaScript runtime.",
    rating: 4.6,
    reviewCount: 6200,
  ...
  },
  {
    ...
    rating: 4.7,
    reviewCount: 3500,
    imageSrc: "/courses/aws.jpg"
  },
  {
    id: 7,
    title: "Expert Design",
    description: "Unlock your creative potential and learn expert design techniques.",
    rating: 4.9,
    reviewCount: 4800,
    imageSrc: "/courses/expertdesign.jpg"
  },
  {
    id: 8,
    title: "Data Structures & Algorithms",
    description: "Enhance your problem-solving skills with DSA for optimal solutions.",
    rating: 4.9,
    reviewCount: 5300,
  ...
  return (
    <section className="py-16">
      <div className="container mx-auto px-6">
        <h2 className="text-3xl font-bold mb-6 text-gray-800">Discover the Variety of Courses Here</h2>
